...
const AdminTickets = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (editId) { await api.put(`/tickets/${editId}`, data); toast.success('Ticket updated'); }
    ...
    const handleDelete = async (id: string) => {
        ...
        try { await api.del(`/tickets/${id}`); fetchTickets(); toast.success('Ticket deleted'); } catch (err: any) { toast.error(err.message); }
    };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-1 order-1 lg:order-2">
                        <div className="bg-gray-800 border border-white/10 p-4 sticky top-4">
                            ...
                            <img
                                src="/assets/admin-previews/tickets-list.webp"
                            ...
                            />
                            <p className="text-[10px] text-gray-600 mt-2 text-center">Ref: tickets-list.webp</p>
                        </div>
                    </div>
                </div>
            )}
